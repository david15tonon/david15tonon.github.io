...
export function page(options: Page): string {
  ...
  const image = options.image ?? { url: "https://david15tonon.github.io/assets/media/preview.jpg", alt: "Cover of WIRED magazine, May/June 1993, \"Rebels with a Cause (Your Privacy)\", showing three people wearing white masks marked with a barcode and numbers" };
  return `<!DOCTYPE html>
